...
import static com.firststory.firstoracle.templates.DemoUtils.ioResourceToByteBuffer;
...
public class ColoredTriangleDemo {
    ...
    private static long createPipeline(VkDevice device, long renderPass, VkPipelineVertexInputStateCreateInfo vi) throws IOException {
        ...
        shaderStages.get(0).set(loadShader(device, "resources/First Oracle/vert.spv", VK_SHADER_STAGE_VERTEX_BIT));
        shaderStages.get(1).set(loadShader(device, "resources/First Oracle/frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT));

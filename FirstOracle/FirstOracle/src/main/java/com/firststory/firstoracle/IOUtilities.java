...
public class IOUtilities {
    ...
    public static java.awt.Font loadFontFromResource(String resourceName,boolean externalFile) throws IOException{
        InputStream is;
        if(externalFile){
        ...
        try{
            ...
            try{
                ...
                throw new IOException("Invalid font file content. Error #1:\n"+ex+"\nError #2:\n"+ex1);
            }
        }
        return font;
    }
